...
HITOS = [
    ...
    dict(id='rueda', pos=0.42, ep=u'3.500 a.C.', t=u'La rueda y el metal',
         ...
         c4=u'La rueda es un caso de libro de <b>transferencia tecnol&oacute;gica</b>: nace como torno cer&aacute;mico y tarda siglos en aplicarse al transporte. La metalurgia, por su parte, exige hornos, min&iacute;a y comercio a distancia: la primera cadena de suministro de la historia.'),
