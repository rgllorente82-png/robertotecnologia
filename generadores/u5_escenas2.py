...
ESC_TRANSFORMA = u'''
      ...
      (function(){
        ...
        function perfil(a){
          ...
          if(modo === 'prog'){
            /* sube en 150 grados, se queda arriba 90, cae en 60 y descansa 60 */
            if(g < 150) return RMIN + H*(1 - Math.cos(Math.PI*g/150))/2;
            if(g < 240) return RMIN + H;
            if(g < 300) return RMIN + H*(1 + Math.cos(Math.PI*(g-240)/60))/2;
            return RMIN;
          }
        ...
        function leva(){
          ...
          var E = 2.2, cx = 180, cy = 248, m = '', fase = ang;
          ...
          if(modo === 'suave'){
            ...
            pie.innerHTML = 'Aqu&iacute; est&aacute; la gracia de la leva: <b>la forma es el programa</b>. Esta '
              + 'sube despacio, <b>se queda arriba un cuarto de vuelta</b>, cae de golpe y descansa. Ninguno de '
